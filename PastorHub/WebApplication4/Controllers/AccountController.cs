...
using static WebApplication4.Models.RegisterViewModel;
...
namespace WebApplication4.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
           ...
           var role3 = new IdentityRole { Name = "administrator" };
           ...
           roleManager.Create(role3);
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Login, Email = model.Email, AvatarImage = "Standart.png" };
